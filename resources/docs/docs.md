...
The `home-routes` handler in the `my-app.routes.home` namespace
...
The `home-page` function will in turn call the `my-app.layout/render` function
...
The routes are aggregated and wrapped with middleware in the `my-app.handler` namespace:
